...
export default async function ChallengeLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className='desktop:flex desktop:justify-center desktop:-mx-[20px] desktop:bg-primary-100/[36%] desktop:min-h-screen'>
      ...
      <main className='mt-[30px] desktop:mt-[63px] flex flex-col h-full desktop:w-desktop desktop:max-w-desktop desktop:px-[20px] mb-[50px]'>
        {children}
      </main>
    </div>
  );
