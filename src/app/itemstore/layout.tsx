...
export default async function ChallengeLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className='desktop:flex desktop:-mx-[20px] desktop:bg-neutral-200/[45%]'>
      ...
      <main className='desktop:h-screen mt-[43px] flex flex-col gap-[48px] desktop:mx-auto desktop:w-desktop desktop:max-w-desktop desktop:px-[30px]'>
        {children}
      </main>
    </div>
  );
