  ...
  return (
    <section className='mt-[165px] desktop:mt-[120px] mb-[50px]'>
      ...
      <div className='flex flex-col gap-[10px] desktop:gap-[110px] mt-[11px] desktop:mt-[50px]'>
        <div className='flex flex-col items-center w-[333px] desktop:w-[1094px] h-[268px] desktop:h-[711px] bg-primary-100 rounded-[14px] desktop:rounded-[45px] desktop:rounded-[45px] pt-[22px] desktop:pt-[76px] shadow-custom'>
