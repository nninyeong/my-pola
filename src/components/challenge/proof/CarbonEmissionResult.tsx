...
const CarbonEmissionResult = ({ todoChallenge }: CarbonEmissionResultProps) => {
  ...
  return (
    <section className='mt-[165px] desktop:mt-[120px] mb-[50px]'>
      <h1 className='text-[16px] desktop:text-[36px] font-semibold leading-[35px] desktop:leading-[55px]'>탄소계산</h1>
      <div className='flex flex-col gap-[10px] desktop:gap-[110px] mt-[11px] desktop:mt-[50px]'>
        <div className='flex flex-col items-center w-[333px] desktop:w-[1094px] h-[268px] desktop:h-[711px] bg-primary-200 rounded-[14px] desktop:rounded-[45px] desktop:rounded-[45px] pt-[22px] desktop:pt-[76px] shadow-custom'>
          ...
          <div className='relative flex w-[316px] h-[150px] desktop:w-[853px] desktop:h-[405px]'>
            <Image
              src={WinGiftsImage}
              alt='탄소 절감 축하 이미지'
              fill
