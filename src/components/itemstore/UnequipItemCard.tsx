...
const UnequipItemCard = ({ onClick }: UnequipItemCard) => {
  return (
    <div
      onClick={onClick}
      className='desktop:min-w-[376px] desktop:h-[416px] rounded-[23px] p-[1px] bg-gradient-to-b from-[#5996e0] to-[#30527A] min-w-[140px] h-[157px] shadow-primaryCustom'
    >
      <div className='desktop:pb-[55px] desktop:pt-[59px] bg-white rounded-[23px] h-full w-full pb-[10px] pt-[22px] flex flex-col items-center justify-around font-semibold text-neutral-900 '>
        ...
        <h1 className='text-[16px] desktop:text-[20px] desktop:leading-[35px]'>아이템 벗기</h1>
      </div>
    </div>
  );
};
