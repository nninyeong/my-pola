...
export default function FriendUrlCopyButton({ currentUserId }: FriendUrlCopyButtonProps) {
  ...
  return (
    <button
      ...
      className='fixed bottom-[85px] left-1/2 -translate-x-1/2 bg-primary-300 w-[339px] desktop:w-[1200px] h-[68px] desktop:h-[164px] flex justify-center items-center rounded-[8px] desktop:rounded-[30px] desktop:px-[90px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]'
    >
      <Image
        ...
        width={237.37}
        height={241}
        className='object-contain w-[108.34px] h-[110px] desktop:w-[237.37px]'
      />
