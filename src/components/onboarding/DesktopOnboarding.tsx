  ...
  return (
    ...
    >
      <section className='w-full'>
        ...
        <div className='flex flex-col justify-center items-center gap-[20px] max-w-[1248px] h-[calc(100vh-167px)] mx-auto py-[20px] animating-div'>
      ...
      <section className='w-full bg-gradient-to-b from-primary-100 to-white'>
        <div className='flex flex-col justify-center items-center gap-[20px] max-w-[1248px] h-[calc(100vh-167px)] mx-auto py-[40px] animating-div'>
